...
- Custom Docker Image로 데이터베이스 생성
  ...
  - docker run -it --name db001 -h db001 -p 3306:3306 --net mybridge --net-alias=db001 -v "$(pwd)/db/db001/data":/var/lib/mysql -v "$(pwd)/db/db001/log":/var/log/mysql -v "$(pwd)/db/db001/conf":/var/percona-server.conf.d -e MYSQL_ROOT_PASSWORD="root" -d mysql157:0.0
  - docker run -it --name db002 -h db002 -p 3307:3306 --net mybridge --net-alias=db002 -v "$(pwd)/db/db002/data":/var/lib/mysql -v "$(pwd)/db/db002/log":/var/log/mysql -v "$(pwd)/db/db002/conf":/var/percona-server.conf.d -e MYSQL_ROOT_PASSWORD="root" -d mysql157:0.0
  - docker run -it --name db003 -h db003 -p 3308:3306 --net mybridge --net-alias=db003 -v "$(pwd)/db/db003/data":/var/lib/mysql -v "$(pwd)/db/db003/log":/var/log/mysql -v "$(pwd)/db/db003/conf":/var/percona-server.conf.d -e MYSQL_ROOT_PASSWORD="root" -d mysql157:0.0
